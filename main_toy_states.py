...
if __name__ == '__main__':
    ...
    parser.add_argument("-b", "--results_filename", help="Set results filename (default='').", default='res_toy_states3_[1, 2, 3, 4, 5].npz', type=str)
    ...
    # save results
    np.savez('res_toy_states3_{0}.npz'.format(states), MEASURES=MEASURES, methods=methods, params=params,
