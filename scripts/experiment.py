...
if __name__ == '__main__':
    ...
    parser.add_argument("-f", "--train_frac", help="Fraction of training exms (default=0.15)", default=0.75, type=float)
    ...
    parser.add_argument("-m", "--method_set", help="Select active method set. (default 'full')", default='lb,ksvr,laprls,tcrfr_lbpa,krr', type=str)
